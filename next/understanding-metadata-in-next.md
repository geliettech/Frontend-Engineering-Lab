This PR adds a beginner-friendly article explaining the Next.js Metadata API, including static and dynamic metadata, routing metadata, title templates, and Open Graph metadata with practical examples and best practices.
